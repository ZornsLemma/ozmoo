...
scanline_to_end_at = 312-(27*8) ; SFTODO: 2 flickers, 4 flickers, 8 flickers, 10 flickers, 14 flickers, 16 mostly doesn't flicker but does e.g. pressing keys, 17 just flickers, 18 just flickers, 19 flickers
