...
!error "SFTODO: I think the B+ problem is revealing a flaw in the screen hole code of some kind, it prob works on M128 due to lower PAGE"
ACORN_SCREEN_HOLE = 1 ; SFTODONOW: IF I COMMENT THIS LINE OUT, B+128K PAGE 1900 WORKS
...
; SFTODO: MIGHT BE WORTH SUPPORTING A DEBUG BUILD WHERE THESE MACROS HANG IF &F4 DOESN'T CONTAIN THE FIRST (DYNMEM) RAM BANK - THAT WOULD HELP CATCH CODE WHICH ISN'T CORRECTLY BRACKETED BY BEFORE/AFTER_DYNMEM_READ
