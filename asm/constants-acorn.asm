...
; SFTODONOW: It may well be that we *happen* to have more space free for history in executable just due to alignment that the space allocated for history in low mem, even if that low mem size is >= min specified by user. In that case, we should be using the larger space.
