...
; The following two locations are only used during the initial data load when we
; know jmp_buf is not going to used. SFTODONOW: CHECK THIS IS TRUE
progress_indicator_blocks_per_chunk = jmp_buf ; 1 byte
progress_indicator_blocks_left_in_chunk = jmp_buf + 1 ; 1 byte
