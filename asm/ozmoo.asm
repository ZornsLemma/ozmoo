...
; SFTODONOW: Is there a potential problem with the command history vs OS cursor editing stuff with shift on the Electron, just because of the different keyboard layout? Not sure, but check and see if this can be tweaked to work.
