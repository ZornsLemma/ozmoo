...
z_ins_read_char
	...
	; SFTODO: Can we just have ACORN => !USE_BLINKING_CURSOR and not have to test ACORN explicitly here and in other places??
!ifndef ACORN {
...
!ifdef USE_HISTORY {
	...
	cmp #131
	bcs +
	jmp handle_history ; SFTODO: WE USED TO BCC TO IT, CAN WE STILL DO THAT ON ACORN?
+
}
