...
!error "SFTODO (ARB POINT IN CODE) THINGS ARE BREAKING BECAUSE TURBO MODE (FEF0) GETS DISABLED - B-EM DEBUGGER SHOWS THINGS (AT LEAST FOR FIRST Z-BYTE READ) ARE ACTUALLY WORKING CORRECTLY OTHERWISE - NEED TO TRACE WHY THIS GETS DISABLED AND HOW I CAN AVOID IT, MAYBE READ TUBE ROM CODE"
-   ldy #0
	lda (mempointer),y
!ifdef ACORN_SWR {
