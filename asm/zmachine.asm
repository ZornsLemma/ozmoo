...
!if 0 { ; SFTODOHACK - JUST ASSUME WE DON'T NEED ANY FANCY DYNMEM STUFF AS THIS IS IN MAIN RAM TO SEE IF IT HELPS PERFORMANCE
	tay
	iny
	...
	; SFTODONOW: WE COULD IN FACT PATCH THIS CODE IN OZMOO.ASM WHEN WE INIT Z_LOW_GLOBAL_VARS_PTR AND JUST DO ABS,Y ADDRESSING, MAYBE EVEN ABODIING THE INY
	tay
	iny
