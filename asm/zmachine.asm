...
; SFTODO: SO WE WHERE IS Z_LOCAL_VARS_PTR SET, FOR MY POSSIBLE !COMPLEX_MEMORY SCREEN HOLE HACK? - OK, THIS IS SET IN STACK.ASM AND I THINK IT ALWAYS POINTS TO THE Z-MACHINE STACK, WHICH MEANS IT DOESN'T NEED ANY SPECIAL HANDLING
...
; SFTODO: IT'S POSSIBLE THAT THERE'S A SAVING TO BE HAD BY RECOGNISING AT RUNTIME OR BUILD TIME THAT ON A BIGDYN BUILD EVEN WITH NO SCREEN HOLE, THE GLOBAL VARS MAY WELL LIVE BELOW $8000 AND CAN BE ACCESSED WITHOUT NEEDING TO PAGE IN DYNMEM SWR BANK. (THIS IS PROBABLY ONLY USEFUL IF I CHANGE BIGDYN TO PAGE IN ONLY WHEN NECESSARY, AS OPPOSED TO CURRENT MODEL.)
