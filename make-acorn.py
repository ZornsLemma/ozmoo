...
# SFTODONOW: There may be a bug in fast hardware scrolling shown up by Varicella. Run it on a M128 in mode 3, and just type 'r' at the first command prompt. A fragment of some scrolled-off text appears on the bottom line. Not sure what's going on.
