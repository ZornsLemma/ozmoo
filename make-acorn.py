...
# SFTODO: Could we wrap the BASIC loader to make it *RUNnable, and then compress that executable as we do with the main Ozmoo executables? That might save a bit of space on the disc and/or speed up loading. Might want to make this optional, and as I do highly value the ability for users/testers to make tweaks to the loader code directly on their machines for debugging purposes, I don't want to do anything to jeopardise that.
