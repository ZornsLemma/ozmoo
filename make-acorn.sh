...
acme --setpc "\$800" -DACORN=1 -DSTACK_PAGES=4 -DZ3=1 --cpu 6502 --format plain -DSMALLBLOCK=1 -DVMEM=1 -DSPLASHWAIT=0 -l "../temp/acme_labels.txt" -r "../temp/acme_report.txt" --outfile "../temp/ozmoo" ozmoo.asm
