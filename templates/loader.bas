...
REM SFTODO: The loader should probably check the file system is DFS/ADFS as
REM appropriate, though be careful - it's possible some DFS-like filing
REM systems return their own code, and as long as a) the catalogue is DFS-like
REM and b) OSWORD &7F works we won't have any problems. If I start parsing
REM raw ADFS catalogues, checking the filing system is ADFS is probably not
REM unreasonable though.
